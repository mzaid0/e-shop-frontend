...
const Banner = ({ data }) => {
    return (
        <div className="min-h-[550px] flex items-center justify-center py-12 px-4">
            <div className="container" >
                <div style={{ backgroundColor: data.bgColor }} className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl">
                    ...
                    <div
                        ...
                        <img src={data.image} alt="" className="scale-125 w-[250px] md:w-[320px] mx-auto drop-shadow-2xl object-cover" />
                    </div>
