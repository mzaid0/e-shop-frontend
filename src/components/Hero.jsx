...
function Hero() {
    ...
    return (
        <div className="container">
            <div className="overflow-hidden rounded-3xl min-h-[550px] flex items-center justify-center sm:min-h-[650px] hero-bg-color ">
                                ...
                                <div key={data.id}>
                                    <div className="grid grid-cols-1 sm:grid-cols-2">
                                        <div className="flex flex-col justify-center gap-4 sm:pl-3 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10">
                                            ...
                                            data-aos-duration="500"
                                            data-aos-once="true"
                                            className="text-5xl uppercase text-white dark:text-white/5 sm:text-[80px] md:text-[100px] xl:text-[150] font-bold">{data.title2}</h1>
                                            <div
                                            data-aos="fade-up"
                                            data-aos-offset="0"
                                            data-aos-duration="500"
